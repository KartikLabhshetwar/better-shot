...
func bitRate(_ w: Int, _ h: Int) -> Int { max(20_000_000, w * h * 4) }
assert(bitRate(2560, 1440) == 20_000_000, "1440p bitrate should clamp to 20Mbps")
assert(bitRate(3840, 2160) == 33_177_600, "4K bitrate wrong")
let oldRate = 2560 * 1440 * 30 * 4
assert(oldRate / bitRate(2560, 1440) > 20, "sanity: old formula should be >20x larger")
