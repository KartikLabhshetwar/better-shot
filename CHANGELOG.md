...
- Removed WebP from Settings > General > File Format. macOS can open WebP images but cannot write them, so every capture and editor Save failed while it was selected. A saved WebP choice now falls back to PNG.
