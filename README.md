...
- **Native Settings:** a native sidebar search field, compact neutral SF Symbols, a single section title, and grouped controls follow the macOS System Settings layout.
