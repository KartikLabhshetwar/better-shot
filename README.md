...
- **Media Gallery:** Finder-style icon and list views with separate On this Mac and Cloud Shares sections for screenshots and videos, toolbar search, date sorting, and a location/status bar. Shared media with a local source appears in both locations. Click to select, double-click to open, or use the item menu to edit, reveal, copy cloud links, or delete with confirmation.
