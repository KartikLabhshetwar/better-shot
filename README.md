...
- **3D video shots** — Effects > 3D Shots offers camera moves, still angles, editable start/end poses, and automatic scenes. Drag shots and their edges in the timeline; preview, export, and sharing use the same perspective geometry.
