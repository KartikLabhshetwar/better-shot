...
await renderMedia({serveUrl,composition,browserExecutable,codec:'h264',crf:23,concurrency:2,outputLocation:path.resolve(root,'../../public/features/recording-demo.mp4'),onProgress:({renderedFrames})=>{if(renderedFrames%150===0)console.log(`Rendered ${renderedFrames}/${composition.durationInFrames} frames`)}})
