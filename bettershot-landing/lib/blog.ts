...
export const posts: Post[] = [
  {
    ...
    title: "BetterShot 0.5: rebuilt from the ground up",
    headline: "BetterShot 0.5: rebuilt from the ground up",
    description:
      "The 0.5 release rebuilds BetterShot's editors, capture deck, settings, and onboarding. A CleanShot X-level screenshot experience, 75 shortcuts, URL scheme, media gallery, five cursor styles, and six community PRs.",
    date: "2026-09-10",
    ...
    keywords: [
      "bettershot 0.5",
      "bettershot release",
      "cleanshot x alternative free",
      "mac screenshot app 2026",
      ...
      "bettershot capture deck",
      "bettershot media gallery",
    ],
  },
  {
