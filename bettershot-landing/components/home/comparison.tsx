...
const rows: { label: string; cells: Cell[] }[] = [
  ...
  { label: "Image editor", cells: [true, "partial", false, false] },
  { label: "Screen recording", cells: [true, true, true, true] },
  { label: "Video editor", cells: [true, false, false, true] },
  { label: "Cursor auto-zoom", cells: [true, false, false, "partial"] },
  { label: "Cursor styling", cells: ["5 styles", false, false, false] },
  ...
  { label: "Backgrounds", cells: ["10 gradients", true, false, true] },
  { label: "URL scheme", cells: [true, true, false, false] },
  { label: "Customizable shortcuts", cells: ["75", "partial", false, false] },
  { label: "Auto-save recordings", cells: [true, true, false, false] },
