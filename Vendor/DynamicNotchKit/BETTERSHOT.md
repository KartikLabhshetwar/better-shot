...
The optional interruptible spring is adapted from that project's ContentView.
...
hover to BetterShot. Normal expansion/collapse uses a short critically damped
spring, disabled with Reduce Motion. No animated blur surfaces are used.
