...
nonisolated enum ClipCompositionBuilder {
    static func makeComposition(videoTrack: AVAssetTrack, audioTrack: AVAssetTrack?, clips: [Clip]) throws -> AVMutableComposition {
        ...
        for clip in clips {
            ...
            if let audioTrack, let compAudioTrack {
                try? compAudioTrack.insertTimeRange(range, of: audioTrack, at: insertionTime)
            }
