    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("New screenshots and exported recordings both land here. The default is your Desktop. Anything you type in the file name is kept as typed; the + button adds a date, a random string, or a counter.")
            }
